...
public class WebServiceTester {
	...
	private String REST_SERVICE_URL = "http://localhost:8080/REST-UserManagement/rest/UserService/users";
	...
	private void testGetAllUsers() {
		...
		System.out.println(client.target(REST_SERVICE_URL).request(MediaType.APPLICATION_XML).get(String.class));
		String result = PASS;
		if (users.isEmpty()) {
			result = FAIL;
		}
